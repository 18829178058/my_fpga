...
HD_PWD='D:/GitHub/my_fpga/2_XilinxFpga_AMD/20260403_IIC_2_zhengdianyuanzi/proj/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_e2prom.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_e2prom.tcl -notrace
