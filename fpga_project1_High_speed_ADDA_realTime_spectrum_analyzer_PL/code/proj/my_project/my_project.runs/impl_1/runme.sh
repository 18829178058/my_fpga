...
HD_PWD='D:/GitHub/my_fpga/fpga_project1_High_speed_ADDA_realTime_spectrum_analyzer_PL/code/proj/my_project/my_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ad_da_fft_lcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_ad_da_fft_lcd.tcl -notrace
