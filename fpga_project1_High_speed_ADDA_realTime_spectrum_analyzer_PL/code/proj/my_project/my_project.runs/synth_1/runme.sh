...
HD_PWD='D:/GitHub/my_fpga/fpga_project1_High_speed_ADDA_realTime_spectrum_analyzer_PL/code/proj/my_project/my_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ad_da_fft_lcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ad_da_fft_lcd.tcl
