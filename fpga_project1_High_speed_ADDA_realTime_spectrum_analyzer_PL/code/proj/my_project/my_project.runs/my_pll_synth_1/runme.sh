...
HD_PWD='D:/GitHub/my_fpga/fpga_project1_High_speed_ADDA_realTime_spectrum_analyzer_PL/code/proj/my_project/my_project.runs/my_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_pll.tcl
