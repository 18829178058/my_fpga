...
#
# Generated by export_simulation on Sat Oct 25 16:29:48 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './fir_lowpass.sh' script.

./fir_lowpass.sh -reset_run
...
./fir_lowpass.sh -noclean_files

For more information on the script, please type './fir_lowpass.sh -help'.
