...
HD_PWD='C:/Users/zxope/Desktop/exam01/prj17/prj/my_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_led.tcl -notrace
