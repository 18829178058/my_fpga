set_property PACKAGE_PIN U16 [get_ports {out_led[3]}]
set_property PACKAGE_PIN E19 [get_ports {out_led[2]}]
set_property PACKAGE_PIN U19 [get_ports {out_led[1]}]
set_property PACKAGE_PIN V19 [get_ports {out_led[0]}]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {out_led_OBUF[0]} {out_led_OBUF[1]} {out_led_OBUF[2]} {out_led_OBUF[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list clk_in_IBUF]]
