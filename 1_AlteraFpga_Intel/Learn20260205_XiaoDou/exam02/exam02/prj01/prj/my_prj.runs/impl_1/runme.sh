...
HD_PWD='C:/Users/zxope/Desktop/exam02/prj01/prj/my_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic.tcl -notrace
