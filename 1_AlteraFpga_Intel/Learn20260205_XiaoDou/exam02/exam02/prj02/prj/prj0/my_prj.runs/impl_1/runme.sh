...
HD_PWD='C:/Users/zxope/Desktop/exam02/prj02/prj/my_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sale_auto.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sale_auto.tcl -notrace
