...
HD_PWD='C:/Users/zxope/Desktop/exam02/prj02/prj/my_prj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sale_auto.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sale_auto.tcl
